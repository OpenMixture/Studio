...
This is the parameter/preview slice of M5-04. PNG encoding/download, independently decoded export bytes/metadata and the complete three-material open → edit → preview → export workflow remain open. Full M5-04 acceptance, M5-05 quality/stress/CI, publishing, Studio editing and M6 are separate work.
