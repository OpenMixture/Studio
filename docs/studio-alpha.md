...
The [external trial](./external-trial.md) now runs the accepted npm Alpha on GitHub Pages; [current deployment evidence](./evidence/pages-npm/README.md) supersedes the initial historical-runtime deployment. The owner handles recruitment and feedback. ALPHA-03 and registry consumption have passed; ALPHA-05 still requires human outcomes.
