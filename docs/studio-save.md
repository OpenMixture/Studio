...
[Evidence](./evidence/studio-save/README.md) records the tested revision and environment separately from remote integration. STUDIO-01 through STUDIO-04 are implemented; STUDIO-05 saved-file qualification through independent Player and native CLI with the 1K material matrix remains the next batch. This does not publish the runtime, host the product publicly, or establish broader browser support.
