...
[Evidence](./evidence/studio-save/README.md) records the tested revision and environment separately from remote integration. STUDIO-01 through STUDIO-05 are complete within the [recorded saved-file matrix](./evidence/studio-qualification/README.md); the implementation is [integrated into main](./studio-integration.md), while wider qualification remains separate. This does not publish the runtime, host the product publicly, or establish broader browser support.
