...
**Next phase:** [Studio MVP stabilization and external trial](./docs/studio-alpha.md) assigns branch protection, ordinary-browser qualification, candidate-runtime upgrade acceptance, focused entry cleanup and user trials to this repository. Current-candidate package CI and npm release remain engine-owned dependencies. These items are planned, not completed; advanced editor features and M6 remain deferred.
